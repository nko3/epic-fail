...
~~~sh
git clone git@github.com:nko3/epic-fail.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-epic-fail --password DgEZ4fPr/crtwcR+
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/epic-fail" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280872
[3]: https://github.com/nko3/epic-fail
